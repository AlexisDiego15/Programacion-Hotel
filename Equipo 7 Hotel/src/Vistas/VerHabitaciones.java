...
class VerHabitaciones extends JFrame implements ActionListener, MouseListener {
    EmpleadoMotor aux;
    ...
    public VerHabitaciones() throws ClassNotFoundException{
    ...
    void init() {
        ...
        instruccion2 = new JLabel("           Seleccione la habitacion que quiere ver       ");
       ...
       nombre_lbl = new JLabel("Nombre de la habitacion");
        ...
        carac_lbl.setBounds(550, 70, 240, 40);
        ...
        scroll.setBounds(550, 110, 240, 240);
