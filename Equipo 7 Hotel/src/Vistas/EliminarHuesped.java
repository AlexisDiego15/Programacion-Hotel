...
class EliminarHuesped extends JFrame implements ActionListener, MouseListener {
    EmpleadoMotor aux;
    ...
    JButton regresar, cerrarcambio, confirmar;
    ...
    public EliminarHuesped() throws ClassNotFoundException{
    ...
    void init() {
        ...
        instruccion2 = new JLabel("           Seleccione el huesped para eliminar la reservacion     ");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==cerrarcambio){
            ...
            cerrarcambio.setVisible(false);
            instruccion2.setText("         Seleccione la reservacion que quiere eliminar        ");
            panelfecha.setVisible(false);
            scrollpane.setVisible(true);
        }
        if(e.getSource()==confirmar){
            Calendario c = new Calendario();
            int ideh=Integer.parseInt(prov.getText());
            for(int i=0; i<Huesped.size(); i++){
    ...
    public void mouseClicked(MouseEvent e) {
            ...
            for(int j=0; j<Habitacion.size(); j++){
                if(Huesped.get(i).getHabitacion()==Habitacion.get(j).getId()){ 
                    if(Huesped.get(i).getId()==codigo){
                        caracteristicas_txt.setText("Reservacion de " +Huesped.get(i).getNombre() +" "+Huesped.get(i).getApellidos() +
                        "en "+Habitacion.get(j).getNombre()+" del "
        ...
        prov.setText(""+codigo);
        instruccion2.setText("        De click en confirmar si desea eliminar la reservacion      ");
