...
class EliminarEmp extends JFrame implements ActionListener, MouseListener {
    EmpleadoMotor aux; 
    ...
    public EliminarEmp() throws ClassNotFoundException{
    ...
    void init() {
        ...
        instruccion2 = new JLabel("           Seleccione el empleado que quiere eliminar       ");
        ...
        confirmar = new JButton("Eliminar empleado");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==cerrarcambio){
            ...
            cerrarcambio.setVisible(false);
            instruccion2.setText("         Seleccione el empleado que quiere eliminar    ");
            scrollpane.setVisible(true);
            panelfecha.setVisible(false);
        }
        if(e.getSource()==confirmar){
            String user = user_txt.getText();
            int ax = JOptionPane.showConfirmDialog(null, "¿Seguro que desea eliminarlo?");
                if (ax == JOptionPane.YES_OPTION) {
                try {
                    aux.eliminar(user);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(EliminarEmp.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        instruccion2.setText("        Da click en el boton si desea eliminarlo     ");
